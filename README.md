...
3. **Customize the prompt**: We provide a default system prompt in [prompts.py](src/agent/prompts.py). You can easily update this via configuration in the studio.
